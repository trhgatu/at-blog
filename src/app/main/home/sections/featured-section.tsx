        ...
        <section className="bg-white dark:bg-gray-900 py-16 px-8 border rounded-md">
            <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2">
                    <h2 className="text-3xl font-lora font-bold text-gray-800 dark:text-gray-200 mb-4">
                        Hóa ra
                    </h2>
                    <blockquote className="font-work">
                        ...
                        và cảm nhận được sự hiện diện của người đó, ngay cả khi họ không còn ở cạnh.<br/>
                        <br />
